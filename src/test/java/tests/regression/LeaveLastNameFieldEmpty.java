...
public class LeaveLastNameFieldEmpty {
    ...
    @Test(groups = {"regression","empty_lastName_field"})
    public static void buyMultipleProducts() {
        openProduct();
        productOptions();
        viewCartAndProceed();
        enterDetailsWhileLeavingLastNameFieldEmpty();
    }
    ...
    public static void enterDetailsWhileLeavingLastNameFieldEmpty() {
