...
public class LeaveStreetAddressFieldEmpty {
    ...
    @Test(groups = {"regression","empty_streetAddress_field"})
    public static void buyMultipleProducts() {
        openProduct();
        productOptions();
        viewCartAndProceed();
        enterDetailsWhileLeavingStreetAddressFieldEmpty();
    }
    ...
    public static void enterDetailsWhileLeavingStreetAddressFieldEmpty() {
