...
public class LeavePhoneNumberFieldEmpty {
    ...
    @Test(groups = {"regression","empty_phoneNumber_field"})
    public static void buyMultipleProducts() {
        openProduct();
        productOptions();
        viewCartAndProceed();
        enterDetailsWhileLeavingPhoneNumberFieldEmpty();
    }
    ...
    public static void enterDetailsWhileLeavingPhoneNumberFieldEmpty() {

        final WebElement firstNameField = driver.findElement(GlobalFields.firstNameField);
        firstNameField.sendKeys(Randomizer.randomLastName());
        ThreadSleeper.sleepSeconds(2);
