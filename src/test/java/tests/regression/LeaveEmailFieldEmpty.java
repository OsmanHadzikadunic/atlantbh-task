...
public class LeaveEmailFieldEmpty {
    ...
    @Test(groups = {"regression","empty_email_field"})
    public static void buyMultipleProducts() {
        openProduct();
        productOptions();
        viewCartAndProceed();
        enterDetailsWhileLeavingEmailFieldEmpty();
    }
    ...
    public static void enterDetailsWhileLeavingEmailFieldEmpty() {
