...
public class LeaveFirstNameFieldEmpty {
    ...
    @Test(groups = {"regression","empty_firstName_field"})
    public static void buyMultipleProducts() {
        openProduct();
        productOptions();
        viewCartAndProceed();
        enterDetailsWhileLeavingFirstNameFieldEmpty();
    }
    ...
    public static void enterDetailsWhileLeavingFirstNameFieldEmpty() {
