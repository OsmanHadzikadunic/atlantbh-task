...
public class LeaveZipCodeFieldEmpty {
    ...
    @Test(groups = {"regression","empty_zipcode_field"})
    public static void buyMultipleProducts() {
        openProduct();
        productOptions();
        viewCartAndProceed();
        enterDetailsWhileLeavingZipCodeFieldEmpty();
    }
    ...
    public static void productOptions() {
        ...
        ThreadSleeper.sleepSeconds(2);
        Assert.assertEquals(driver.getCurrentUrl(), GlobalValues.regressionProduct);
    }
    ...
    public static void enterDetailsWhileLeavingZipCodeFieldEmpty() {
